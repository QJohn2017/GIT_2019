...
git_par.itdp = 1;                %1: time-dependent , 0: time-independent
    
git_par.f = 3.27;               % focal length of cavity lens (m)
...
git_par.nslice=800;
git_par.cavitydetuning = 165;    % In units of zsep
git_par.transmission = .15;          % Power transmission through one cavity pass
...
init_rms(iss)=r_size(1); %plot initial rad spot size
