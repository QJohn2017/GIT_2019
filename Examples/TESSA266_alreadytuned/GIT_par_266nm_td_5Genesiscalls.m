...
% power0=power;z0=z;energy0=energy;bunching0=bunching;p_mid_M0=p_mid_M; r_size0=r_size; K_undulator0=K_undulator; xrms0=xrms; yrms0=yrms; ephase0=ephase;phi_mid_M0=phi_mid_M;
...
GIT_fun_2019;
%read_genesis_onerun;
power1=power;z1=z;energy1=energy;bunching1=bunching;p_mid_M1=p_mid_M; r_size1=r_size; K_undulator1=K_undulator; xrms1=xrms; yrms1=yrms; 
...
GIT_fun_2019;
%read_genesis_onerun;
power2=power;z2=z;energy2=energy;bunching2=bunching;p_mid_M2=p_mid_M; r_size2=r_size; K_undulator2=K_undulator; xrms2=xrms; yrms2=yrms;
...
GIT_fun_2019;
%read_genesis_onerun;
power3=power;z3=z;energy3=energy;bunching3=bunching;p_mid_M3=p_mid_M; r_size3=r_size; K_undulator3=K_undulator; xrms3=xrms; yrms3=yrms; 

%% fourth undulator
copyfile(maginfile4,[dirname,'mg.mag.in']);
GIT_fun_2019;
%read_genesis_onerun;
power4=power;z4=z;energy4=energy;bunching4=bunching;p_mid_M4=p_mid_M; r_size4=r_size; K_undulator4=K_undulator; xrms4=xrms; yrms4=yrms;
toc
...
p_mid_M=[p_mid_M1(:,2:end),p_mid_M2(:,2:end),p_mid_M3(:,2:end),p_mid_M4(:,2:end)];
